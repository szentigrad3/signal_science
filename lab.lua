...
data:extend(
{
  ...
  },
 {
    ...
    energy_usage = "60kW",
    researching_speed = 1,
    signal_to_research_mapping =
    {
      {type="virtual", name="signal-1-data"},
      {type="virtual", name="signal-2-data"},
      {type="virtual", name="signal-3-data"},
      {type="virtual", name="signal-4-data"},
      {type="virtual", name="signal-5-data"},
      {type="virtual", name="signal-6-data"},
	  {type="virtual", name="signal-7-data"}
    },
